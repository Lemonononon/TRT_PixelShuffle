...
{
public:
    PixelShufflePlugin(int upscaleFactor)
    ...
    {
        memcpy(&mUpscaleFactor, data, sizeof(mUpscaleFactor));
    }
    ...
    void configurePlugin(const nvinfer1::DynamicPluginTensorDesc* inputs, int nbInputs, const nvinfer1::DynamicPluginTensorDesc* outputs, int nbOutputs) noexcept override {}
    ...
    {
        memcpy(buffer, &mUpscaleFactor, sizeof(mUpscaleFactor));
    }
...
public:
    PixelShufflePluginCreator()
    {
        ...
        mPluginAttributes.emplace_back(nvinfer1::PluginField("upscaleFactor", nullptr, nvinfer1::PluginFieldType::kINT32, 1));
